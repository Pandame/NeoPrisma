...
//
//
//var videoTexture = new THREEx.VideoTexture("upload/testold.ogv");
...
//var materialVideo = new THREE.MeshBasicMaterial({map : videoTexture.texture}); // cela permet d'importer des vidéos non reconnues, pour qu'elles ne soient pas mises comme danger.
...
//var source = "upload/"+mavariable;
var source="upload/manege.DAE";

var loader = new THREE.ColladaLoader(); 

var controlPanel;
loader.options.convertUpAxis = true; 
loader.load('upload/manege.DAE',function colladaReady( collada ){
...
var materialVideo   = new THREE.MeshLambertMaterial({
  map : dynamicTexture.texture
     ...
     // object.children[ 0 ].material=new THREE.MeshBasicMaterial({map : videoTexture.texture});;
    //  object.children[ 0].material= materialVideo;
      vla = new THREE.Mesh ( object_geometry, materialVideo );



dynamicTexture.texture.needsUpdate  = true;    webgl.appendChild( renderer.domElement );
