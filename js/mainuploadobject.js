...
//
//
var videoTexture = new THREEx.VideoTexture("upload/test3.ogv");
...
//materialVideo = new THREE.MeshBasicMaterial({color: 0xffff00});
...
//var source = "upload/"+mavariable;
var source="upload/slidein.dae";

var loader = new THREE.ColladaLoader(); 

var controlPanel;
loader.options.convertUpAxis = true; 
loader.load('upload/manege15.dae',function colladaReady( collada ){
      object = collada.scene;

      //CODE DE DIEU, JE LE DIS ON PEUT CHANGER LA TEXTURE 
var cote = 5;
object_geometry = collada.scene.children[cote].geometry;
object.children[cote].material= materialVideo;
//object_geometry.faceVertexUvs[cote] = [];
